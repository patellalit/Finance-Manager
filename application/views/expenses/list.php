...
<div class="m-subheader ">
	<div class="d-flex align-items-center">
		<div class="mr-auto">
			<h3 class="m-subheader__title ">Expenses List</h3>
		</div>
...
<div class="m-content">
		<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
			<div class="row align-items-center">
				...
				<div class="col-xl-4 order-1 order-xl-2 m--align-right">
					<a href="<?php echo base_url('expenses/add');?>" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
		...
		<input type="hidden" id="expenses_datatableurl" value="<?php echo base_url('expenses/dataTables');?>">
		<input type="hidden" id="expenses_edit_url" value="<?php echo base_url('expenses/edit/');?>">
		<input type="hidden" id="expenses_delete_url" value="<?php echo base_url('expenses/delete/');?>">
		<div class="expenses_table" id="ajax_data"></div>		
</div>
