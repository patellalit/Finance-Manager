...
<div class="m-subheader ">
	<div class="d-flex align-items-center">
		<div class="mr-auto" style="width: 100%">
			<h3 class="m-subheader__title ">Gross Income List</h3>
...
<div class="m-content">
		...
		<input type="hidden" id="grossincome_datatableurl" value="<?php echo base_url('profit/grossincome_dataTables');?>">
		<input type="hidden" id="grossincome_Balanceurl" value="<?php echo base_url('profit/grossincome_Balance');?>">
		<div class="grossincome_table" id="ajax_data"></div>		
</div>
