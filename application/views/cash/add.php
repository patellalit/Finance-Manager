...
<div class="m-subheader ">
	<div class="d-flex align-items-center">
		<div class="mr-auto">
			<h3 class="m-subheader__title ">Add Cash</h3>
		</div>
	</div>
</div>
<!-- END: Subheader -->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="m-portlet">
				...
				<?php 
			      	$cash_form = array('id'=>'cash_formadd','autocomplete'=>'off','name'=>'cash_formadd','method'=>'post','class'=>'m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed', 'enctype'=>'multipart/form-data');
			    	echo form_open('cash/save',$cash_form);   
				?>
						...
						<div class="col-lg-6">
						 	<?php                                             
				                  $cash_date = array ("name" => "cash_date", "id"=>"cash_date","type"=>"date",
				                                 "class" => "form-control m-input","value"=>set_value('cash_date'));
