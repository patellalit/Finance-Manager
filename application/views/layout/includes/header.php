<!-- BEGIN: Header -->
<style type="text/css">
	.m-card-user__email{font-size: 0.75rem!important;}
</style>
				...
				<div class="m-stack m-stack--ver m-stack--general">
					<div class="m-stack__item m-stack__item--middle m-brand__logo">
						 <!-- <a href="index.html" class="m-brand__logo-wrapper"> <img alt=""
							src="<?php //echo base_url()?>assets/demo/default/media/img/logo/logo_default_dark.png" />
						</a>  -->
						 <!-- <a href="#" class="m-brand__logo-wrapper"> <img width="90px" height="auto" alt=""
							src="<?php //echo base_url('assets/demo/default/media/img/logo/logo_site.png')?>" />
						</a> -->
						<a href="<?php echo base_url('dashboard');?>" class="m-brand__logo-wrapper"> <img width="90px" height="auto" alt=""
							src="<?php echo base_url('assets/demo/default/media/img/logo/finance_logo.jpg')?>" />
						</a>
					</div>
					...
					<div class="m-stack__item m-topbar__nav-wrapper">
						<ul class="m-topbar__nav m-nav m-nav--inline">
							...
							<!-- <li
								...
								m-dropdown-toggle="click" m-dropdown-persistent="1"><a href="#"
								...
								id="m_topbar_notification_icon"> <span
									...
									<span class="m-nav__link-icon"> <i class="flaticon-music-2"></i>
								</span>
							</a>
									...
									<div class="m-dropdown__inner">
										<div class="m-dropdown__header m--align-center" style="background: url(<?php echo base_url()?>assets/app/media/img/misc/notification_bg.jpg); background-size: cover;">
											<span class="m-dropdown__header-title"> 9 New </span> <span
												class="m-dropdown__header-subtitle"> User Notifications </span>
										</div>
																...
																<div class="m-list-timeline__items">
																	...
																	<div class="m-list-timeline__item">
																		<span class="m-list-timeline__badge"></span> <span
																			...
																			class="m-badge m-badge--info m-badge--wide"> settled
																		</span>
																	...
																	<div
																		...
																		<span class="m-list-timeline__badge"></span> <span
																			href="" class="m-list-timeline__text"> New order
																			received <span
																			class="m-badge m-badge--danger m-badge--wide"> urgent
																		</span>
																	...
																	<div
																		class="m-list-timeline__item m-list-timeline__item--read">
																		<span class="m-list-timeline__badge"></span> <span
																			class="m-list-timeline__text"> Production server down
																		</span> <span class="m-list-timeline__time"> 3 hrs </span>
																	</div>
																	<div class="m-list-timeline__item">
																		<span class="m-list-timeline__badge"></span> <span
							...
							<li
								...
								class="m-nav__link m-dropdown__toggle"> <span
									class="m-topbar__userpic"> <img
										src="<?php echo base_url('assets/app/media/img/users/blank-avatar.png')?>"
										...
										<div class="m-dropdown__header m--align-center" style="background: url(<?php echo base_url()?>assets/app/media/img/misc/user_profile_bg.jpg); background-size: cover;">
											<div class="m-card-user m-card-user--skin-dark">
												...
												<div class="m-card-user__details">
													<span class="m-card-user__name m--font-weight-500"><?php echo $this->session->userdata['admin_data']['full_name'] ;?> </span> <a href=""
														class="m-card-user__email m--font-weight-300 m-link"><?php echo $this->session->userdata['admin_data']['email'] ;?></a>
												</div>
											</div>
										</div>
										<div class="m-dropdown__body">
											<div class="m-dropdown__content">
												<ul class="m-nav m-nav--skin-light">
													...
													<li class="m-nav__item"><a href="<?php echo base_url('profile/edit'); ?>"
														class="m-nav__link"> <i
													...
													<li class="m-nav__item"><a href="<?php echo base_url('profile/password_change'); ?>"
														class="m-nav__link"> <i
															class="m-nav__link-icon flaticon-lock"></i> <span
